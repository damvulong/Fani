/*
 * *
 *  * Created by damvulong on 4/19/22, 9:09 PM
 *  * Copyright (c) 2022 . All rights reserved.
 *  * Last modified 4/19/22, 9:09 PM
 *
 */
...
public class LogUtil {
     ...
     */
    public static final String DEFAULT_TAG = "Fani";
        ...
        switch (level) {
            ...
            case ASSERT:
                if (mWtfAvailable) {
                    ...
                    return Log.println(Log.ASSERT, tag, msg);
                }
        }
        ...
        switch (level) {
            ...
            case ASSERT:
                if (mWtfAvailable) {
                    ...
                    return Log.println(Log.ASSERT, tag,
            ...
            switch (level) {
                case ASSERT:
                    if (mWtfAvailable) {
                        ...
                        bytes += Log.println(Log.ASSERT, tag, substr);
                    }
                    break;
                case ERROR:
                    bytes += Log.e(tag, substr);
                    break;
                case WARN:
                    bytes += Log.w(tag, substr);
                    break;
                case INFO:
                    bytes += Log.i(tag, substr);
                    break;
                case DEBUG:
                    bytes += Log.d(tag, substr);
                    break;
                case VERBOSE:
                default:
                    bytes += Log.v(tag, substr);
                    break;
            }
